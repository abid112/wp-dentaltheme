<?php 
/*
Template Name: Indivisual Template
*/ 
?>
		...
		<div class="row">
			<div class="content_wrap">
				<div class="col-md-4 col-sm-4 col-xs-12 no-padding">
					<?php 
						if ( is_active_sidebar( 'indivisual-sidebar' ) ) { ?>
								<?php dynamic_sidebar( 'indivisual-sidebar' ); ?>
					<?php }
					?>
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12 content_holder">
					<?php get_template_part('free','schedule'); ?>
					<div class="page_content_holder template_page_content_holder">
