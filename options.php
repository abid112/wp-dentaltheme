...
function rootstrap_options() {
    ...
    $social_medias_array = array (
        'facebook' => __('Facebook', 'rootstrap'),
        'twitter' => __('Twitter', 'rootstrap'),
        'googleplus' => __('Google+', 'rootstrap'),
        'youtube' => __('Youtube', 'rootstrap'),
        'linkedin' => __('Linkedin', 'rootstrap'),
        'pinterest' => __('Pinterest', 'rootstrap'),
        'rss' => __('RSS', 'rootstrap'),
        'tumblr' => __('Tumblr', 'rootstrap'),
        'flickr' => __('Flicker', 'rootstrap'),
        'instagram' => __('Instagram', 'rootstrap'),
        'dribbble' => __('Dribble', 'rootstrap'),
        'yelp' => __('Yelp', 'rootstrap'),
        'map-marker' => __('Google Map', 'rootstrap'),
        'yahoo' => __('Yahoo', 'rootstrap'),
        'search' => __('Bing', 'rootstrap'),
        'circle-o' => __('Merchant Circle', 'rootstrap'),
        'slideshare' => __('SlideShare', 'rootstrap'),
        'wordpress' => __('Wordpress', 'rootstrap'),
        'medium' => __('Medium', 'rootstrap')
    );
...
//        }
    // Pull all the custom post types into an array
    $options_categories = array();
    $args = array(
        'public' => true,
        '_builtin' => false
    );
    $options_categories_obj = get_post_types($args);
    foreach ($options_categories_obj as $key => $category) {
        $options_categories[$key] = $category;
    }
    ...
    $options[] = array('name' => __('Slider Post-type', 'rootstrap'),
        'desc' => __('Select a post-type for the featured post slider', 'rootstrap'),
    ...
    $options[] = array('id' => 'social_yelp',
        'desc' => __('Yelp', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_map-marker',
        'desc' => __('Google Map', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_yahoo',
        'desc' => __('Yahoo', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_search',
        'desc' => __('Bing', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_circle-o',
        'desc' => __('Merchant Circle', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_slideshare',
        'desc' => __('Slideshare', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_wordpress',
        'desc' => __('Wordpress', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_medium',
        'desc' => __('Medium', 'rootstrap'),
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('id' => 'social_hide-mobile',
        'name' => __('Hide Social Icons on mobile', 'rootstrap'),
        'desc' => __('Default none, if not checked', 'rootstrap'),
        'std' => '',
        'type' => 'multicheck',
        'options' => $social_medias_array);
    ...
    $options[] = array('name' => __('Phone', 'rootstrap'),
        'desc' => __('Enter contact-phone number here', 'rootstrap'),
        'id' => 'site_phone',
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('name' => __('Email', 'rootstrap'),
        'desc' => __('Enter contact-email address here', 'rootstrap'),
        'id' => 'site_mail',
        'std' => '',
        'class' => 'mini',
        'type' => 'text');

    $options[] = array('name' => __('Header Scripts', 'rootstrap'),
        'desc' => __('Add Additional Scripts (html,css,js) at Header', 'rootstrap'),
        'id' => 'custom_header',
        'std' => '',
        'type' => 'editor');

    $options[] = array('name' => __('Footer Scripts', 'rootstrap'),
        'desc' => __('Add Additional Scripts (html,css,js) at Footer', 'rootstrap'),
        'id' => 'custom_footer',
        'std' => '',
        'type' => 'editor');
